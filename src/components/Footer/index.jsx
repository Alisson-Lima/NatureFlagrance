    ...
    return (
        <footer className="Footer flex">
            <div className="container flex ">
                <a href="#" className="logo-part flex ">
                    ...
                    <div className="logo-content">
                        <h4 className="purple">Lorem ipsum</h4>
                        <p>Lorem ipsum dolor</p>
                    </div>
                </a >
                <div className="obs-part ">
                    <h4 className="purple">lorem ipsum dolor sit amet</h4>
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis fringilla velit ut.</p>
                </div>
            </div>
        </footer>
    )
